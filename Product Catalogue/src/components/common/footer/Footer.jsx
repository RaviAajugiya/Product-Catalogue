  ...
  return (
    <>
      <footer className="pt-10 bg-[#131118] text-white ">
        <div className="flex justify-evenly flex-wrap md:gap-10 px-5 max-w-[1200px] m-auto">
          ...
          <div className="p-3 w-[250px]">
            ...
            <div className="flex  items-center gap-4 mt-10 mb-5 border-0 rounded-lg bg-primary-color">
